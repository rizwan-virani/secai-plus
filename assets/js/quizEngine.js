/* secai+ :: quizEngine.js  (assessment + PBQ runtime engine)
...
SECAI.questions = SECAI.questions || [];
SECAI.pbqs = SECAI.pbqs || [];
/* ============================================================================
   secai+  ::  quizEngine.js  —  ENGINE  (assessment + PBQ runtime)
...
(function () {
  ...
  /* Exam figures resolve from SECAI.exam — the single source of truth. No mock
  ...
  /* ===========================================================================
     ...
     Persists two things across every quiz/mock session (localStorage via APP):
       secai.objstats.v1 = { "1.2": {c, n}, ... }   per-objective accuracy
       secai.missed.v1   = { "D4-071": 1, ... }      questions answered wrong
  ...
  /* ===========================================================================
     TIMED MOCK EXAM  (weighted questions per SECAI.exam, timer, flagging, palette)
     =========================================================================== */
