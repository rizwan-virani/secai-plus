/* ============================================================================
   secai+  ::  flashEngine.js  —  Rapid Recall Flashcards
   ...
   - Cards live in lazy-loaded per-domain modules (assets/js/content/flashN.js),
     each populating SECAI.flash[N] with 100 cards { id, d, t, obj, front, back }.
   - Scheduling state persists to localStorage (secai.flash.v1) keyed by card id,
...
(function () {
  ...
  /* Domain ids come from metadata so the deck logic tracks the real domain count
     (4 for SecAI+) instead of a hardcoded range. */
  ...
  function ver() { return window.SECAI_VER ? "?v=" + window.SECAI_VER : ""; }
